...
var _salvarubiomartinez$mci$Models$adhesionManifiestoDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_salvarubiomartinez$mci$Models$AdhesionManifiesto,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'usuarioId', _elm_lang$core$Json_Decode$int),
...
var _salvarubiomartinez$mci$Msgs$SelectColaboracion = function (a) {
	return {ctor: 'SelectColaboracion', _0: a};
};
var _salvarubiomartinez$mci$Msgs$SelectAdhesion = function (a) {
	return {ctor: 'SelectAdhesion', _0: a};
};
var _salvarubiomartinez$mci$Msgs$SelectDenuncia = function (a) {
	return {ctor: 'SelectDenuncia', _0: a};
};
var _salvarubiomartinez$mci$Msgs$GetColaboracion = function (a) {
	return {ctor: 'GetColaboracion', _0: a};
};
var _salvarubiomartinez$mci$Msgs$GetadhesionManifiesto = function (a) {
	return {ctor: 'GetadhesionManifiesto', _0: a};
};
var _salvarubiomartinez$mci$Msgs$GetInfo = function (a) {
	return {ctor: 'GetInfo', _0: a};
};
var _salvarubiomartinez$mci$Msgs$PostColaboracionResponse = function (a) {
	return {ctor: 'PostColaboracionResponse', _0: a};
};
...
var _salvarubiomartinez$mci$Administracion$administracionView = function (model) {
	...
	var tabAdhesiones = _elm_lang$core$Native_Utils.eq(model.selectedTab, _salvarubiomartinez$mci$Models$TabAdhesiones) ? 'active' : '';
	var tabDenuncias = _elm_lang$core$Native_Utils.eq(model.selectedTab, _salvarubiomartinez$mci$Models$TabDenuncias) ? 'active' : '';
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class(tabDenuncias),
								_1: {
									ctor: '::',
									...
									_elm_lang$html$Html$a,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_salvarubiomartinez$mci$Msgs$AdministracionMsg(
												_salvarubiomartinez$mci$Msgs$ChangeTab(_salvarubiomartinez$mci$Models$TabDenuncias))),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(tabAdhesiones),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$a,
										{
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_salvarubiomartinez$mci$Msgs$AdministracionMsg(
													_salvarubiomartinez$mci$Msgs$ChangeTab(_salvarubiomartinez$mci$Models$TabAdhesiones))),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(tabColaboraciones),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_0: _elm_lang$html$Html_Events$onClick(
													_salvarubiomartinez$mci$Msgs$AdministracionMsg(
														_salvarubiomartinez$mci$Msgs$ChangeTab(_salvarubiomartinez$mci$Models$TabColaboraciones))),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('colaboraciones'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												...
												_0: _elm_lang$html$Html_Attributes$class(
													A2(_elm_lang$core$Basics_ops['++'], 'tab-pane', tabDenuncias)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('list-group col-md-4'),
														_1: {ctor: '[]'}
													},
													A2(
														_elm_lang$core$List$map,
																...
																_elm_lang$html$Html$a,
																{
																	...
																	_0: _elm_lang$html$Html_Attributes$class(
																		A2(
																			...
																			'list-group-item',
																			_elm_lang$core$Native_Utils.eq(denuncia.nombre, denun.nombre) ? ' active' : '')),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onClick(
																			_salvarubiomartinez$mci$Msgs$AdministracionMsg(
																				_salvarubiomartinez$mci$Msgs$SelectDenuncia(denun))),
																		_1: {ctor: '[]'}
																	}
																},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(denun.nombre),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text(denun.fecha),
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	}
																	...
																	_0: A2(
																		...
																		{ctor: '[]'},
																		{
																			...
																			_0: _elm_lang$html$Html$text(
																				A2(_elm_lang$core$Basics_ops['++'], 'nombre: ', denuncia.nombre)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{ctor: '[]'},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text(
																					A2(_elm_lang$core$Basics_ops['++'], 'exposicion: ', denuncia.exposicion)),
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	}
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$div,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class(
														A2(_elm_lang$core$Basics_ops['++'], 'tab-pane', tabAdhesiones)),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
																	...
																	_elm_lang$html$Html$a,
																	{
																		...
																		_0: _elm_lang$html$Html_Attributes$class(
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				'list-group-item',
																				_elm_lang$core$Native_Utils.eq(adhesion.info, denuncia.info) ? ' active' : '')),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onClick(
																				_salvarubiomartinez$mci$Msgs$AdministracionMsg(
																					_salvarubiomartinez$mci$Msgs$SelectAdhesion(denuncia))),
																			_1: {ctor: '[]'}
																		}
																	},
																	{
																	...
																	{ctor: '[]'},
																	{
																		...
																		_0: A2(
																			...
																			{ctor: '[]'},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text(
																					A2(_elm_lang$core$Basics_ops['++'], 'nombre: ', adhesion.usuarioId)),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				...
																				{ctor: '[]'},
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text(
																						A2(_elm_lang$core$Basics_ops['++'], 'exposicion: ', adhesion.info)),
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		}
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$div,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class(
															A2(_elm_lang$core$Basics_ops['++'], 'tab-pane', tabColaboraciones)),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
...
var _salvarubiomartinez$mci$EnviarAdhesion$enviarAdhesionView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('adhesion manifiesto'),
			_1: {ctor: '[]'}
		});
};
...
var _salvarubiomartinez$mci$EnviarColaboracion$encodeColaboracion = function (colaboracion) {
...
var _salvarubiomartinez$mci$EnviarDenuncia$enviarDenunciaView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('denuncia'),
			_1: {ctor: '[]'}
		});
};

var _salvarubiomartinez$mci$Index$indexView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Welcome usuario'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _salvarubiomartinez$mci$Index$indexUpdate = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
			...
			case 'UpdateLoginEmail':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							login: {email: _p0._0, psw: model.login.psw}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateLoginPsw':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							login: {email: model.login.email, psw: _p0._0}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SubmitLogin':
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('panel panel-warning'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _salvarubiomartinez$mci$Main$main !== 'undefined') {
    _salvarubiomartinez$mci$Main$main(Elm['Main'], 'Main', undefined);
}
